...
GuiComponent::GuiComponent(Window* window) : mOpacity(255), mWindow(window), mParent(NULL),
	mPosition(Eigen::Vector3f::Zero()), mOrigin(Eigen::Vector2f::Zero()), mRotationOrigin(0.5, 0.5), mSize(Eigen::Vector2f::Zero()), mIsProcessing(false), mTransform(Eigen::Affine3f::Identity())
{
